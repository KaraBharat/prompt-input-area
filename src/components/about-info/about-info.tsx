...
const TwitterIcon = () => (
  <svg
    ...
    height="24"
    viewBox="0 0 32 32"
    className="h-6 w-6 transition-all hover:h-8 hover:w-8 dark:text-white"
    aria-hidden="true"
  >
      ...
      <div className="flex flex-col items-center justify-between">
        <div className="flex items-center justify-center">
          <div className="flex items-center gap-2">
            ...
            />
            <SocialLink
              href="https://github.com/KaraBharat/prompt-input-area"
              icon={<GithubIcon />}
              label="GitHub"
            />
          </div>
      ...
      <p className="flex items-center gap-1 text-sm text-muted-foreground">
        ...
        >
          <Image
            ...
            className="h-5 w-5"
          />
          <span className="hidden md:block">Kara Bharat</span>
        </Link>
      </p>
      <div className="flex items-center">
        <Link
          href="https://buymeacoffee.com/bharatkara"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 rounded-md bg-[#FFDD00] px-3 py-1 text-sm font-semibold text-black hover:bg-[#FFDD00]/90"
